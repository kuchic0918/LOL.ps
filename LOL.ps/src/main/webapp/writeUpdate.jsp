      	...
      	<div class="write-post-post-detail">
      		<form action="Controller" method = "post">
	      		...
	      		<div class="write-post-title">
	      			<div style="font-size:15px; color:#7e9bff; padding-bottom:20px;"><b>게시물 수정</b></div>
	      			...
	      			value="<%=dto.getTitle()%>"/>   			
	           		...
	           		<div style="padding:20px 0px;">
						...
						<textarea style="resize: none;" id="summernote" class="summernote" name="editordata" ><%=dto.getContent()%></textarea>
					</div>
				...
				<div class="complete-btn-div">
					...
					<div style="padding-left: 250px;">
						<button type="submit" class="complete-btn" name="command" value="updateBoard">작성완료</button>
					</div>
				</div>
			</form>				
        </div>

...
//		session.setAttribute("memberInfo", 123);
	...
	<%
		...
		if(memberdao.isVaildEmail(email, conn, pstmt, rs) == true && memberdao.isVaildPW(password, conn, pstmt, rs)== false ) {
	%>
		<script>
	...
	<% 			
		...
		if(memberdao.isVaildEmail(email, conn, pstmt, rs) == false && memberdao.isVaildPW(password, conn, pstmt, rs) == true) {
	...
	<%
		...
		if(memberdao.isVaildEmail(email, conn, pstmt, rs) == false && memberdao.isVaildPW(password, conn, pstmt, rs)==false) {
